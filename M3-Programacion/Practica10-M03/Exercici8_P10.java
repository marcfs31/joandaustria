...
public class Exercici8_P10 {
	public static void main (String[] args) throws IOException  {
		...
		//Insertar nota
		System.out.print("En que posición quieres añadir la nota? ");
		...
		//Correción añadir nota
		float notas2[];
		notas2 = new float[alumnos+1];
		notas2[corregir]=nota_corregir;
		for(int x=0;x<notas2.length;x++){
			if(notas2[x]==nota_corregir){
				while(notas2.length-2>=x){
					x++;
					notas2[x]=notas[x-1];
				}
			}else{
